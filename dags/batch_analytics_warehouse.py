...
with DAG(
    dag_id="batch_analytics_warehouse_pipeline_v2",
        ...
        configuration={
            "query": {
                ...
                USING (
                  ...
                  WHERE DATE(order_ts) = DATE('{PROCESS_DATE}')
                ) S
        ...
        configuration={
            "query": {
                ...
                USING (
                  ...
                  WHERE DATE(event_ts) = DATE('{PROCESS_DATE}')
                ) S
    ...
    build_daily_mart >> [
        dq_orders_present,
        dq_no_duplicate_orders,
        dq_null_customer_rate,
    ]
